...
const Testimonials = () => {
  return (
    <motion.div 
        ...
        <h1 className='text-2xl sm:text-4xl font-bold mb-2 text-center'>Customer <span className='underline underline-offset-4 under font-light'>Testimonials</span></h1>
